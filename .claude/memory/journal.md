...
- [BLK-014](blockers/BLK-014.md) — harnais de test non demandé, 12 min sur 20 (résolu)
- [BLK-012](blockers/BLK-012.md) — `pnpm lint` cassé par rtk captant un ESLint global 9.9.0, diagnostic initial erroné (résolu)
